...
class sciScore extends StatefulWidget {
  const sciScore({Key? key}) : super(key: key);

  @override
  _sciScoreState createState() => _sciScoreState();
}

class _sciScoreState extends State<sciScore> {
  UserModel? userModel;
