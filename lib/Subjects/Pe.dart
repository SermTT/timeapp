...
class peScore extends StatefulWidget {
  const peScore({Key? key}) : super(key: key);

  @override
  _peScoreState createState() => _peScoreState();
}

class _peScoreState extends State<peScore> {
  UserModel? userModel;
